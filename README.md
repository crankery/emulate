Emulate is an 8 bit CPU emulation library written entirely in managed c#. The first CPU to be emulated is the Intel 8080. I have a vague plan of doing the Z80, 6502 and 6809 at some point.
